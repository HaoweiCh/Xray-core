...
var (
	build    = "Self-Driven"
	codename = "X, Connect Everything."
	intro    = "A unified awesome platform for anti-censorship."
)
...
func VersionStatement() []string {
	return []string{
		serial.Concat("X ", Version(), " (", codename, ") ", build, " (", runtime.Version(), " ", runtime.GOOS, "/", runtime.GOARCH, ")"),
		intro,
	}
}
